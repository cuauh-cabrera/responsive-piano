...
# 📖 [Responsive Piano] <a name="about-project"></a>

> This little Piano is one of the many challenges you can find as part of the Responsive Web Design Certificate at FreeCodeCamp.org

**[Responsive Piano]** is aimed to teach you how to make your projects responsive to any screen resolution.
...
- https://cuauh-cabrera.github.io/responsive-piano/
...
```sh
  cd my-folder
  git@github.com:cuauh-cabrera/responsive-piano.git
```
